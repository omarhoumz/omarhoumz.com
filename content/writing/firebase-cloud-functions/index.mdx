...
Let us talk about **Serverless**. From a frontend engineer perspective, your skillset is limited when you need some backend development and/or server operations. Serverless technologies open that field for you.
