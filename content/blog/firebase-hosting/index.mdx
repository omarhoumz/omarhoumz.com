...
If we have a static HTML files based project, I created an example project [here github.com/omarhoumz/wr-firebase-hosting/blob/main/static-html](https://github.com/omarhoumz/wr-firebase-hosting/blob/main/static-html). It only one `index.html` file. You can clone it to follow along, or use you own project.
