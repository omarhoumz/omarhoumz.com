...
In this post we will cover one small, but very much hyped, part of serverless; **cloud functions**. One of the solutions available is firebase's <a href='https://firebase.google.com/docs/functions' target='_blank' rel='nofollow noopener noreferrer'>"Firebase Cloud Functions"</a>.
